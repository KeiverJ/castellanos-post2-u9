...
/**
 * Entidad JPA que representa un curso academico.
 * Lado propietario de la relacion ManyToMany con Estudiante.
 * Define la tabla de union curso_estudiante con @JoinTable.
 */
@Entity
@Table(name = "cursos")
public class Curso {
    ...
    // Lado propietario: define la tabla de union
    @ManyToMany
    ...
    // Helper methods para sincronizar la relacion bidireccional
