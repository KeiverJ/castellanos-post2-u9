# Sistema de Gestión de Estudiantes - Universidad
...
*Nota: Si no existen usuarios, regístrese desde la pantalla de inicio.*
...
*El nombre se muestra usando th:text, escapando cualquier etiqueta HTML maliciosa*
...
*Petición POST sin token CSRF rechazada por Spring Security*
...
*Cabecera presente verificada en las herramientas de desarrollo del navegador (F12)*
...
*Página personalizada que muestra el usuario autenticado y un mensaje claro de error*
...
- **Nombre:** Keiver Esneid Castellanos Julio
- **Correo:** keiverecj@gmail.com
- **Repositorio:** https://github.com/KeiverJ/castellanos-post2-u9

---

## Licencia

Este proyecto es parte de una evaluación académica de la universidad. Todos los derechos reservados.
